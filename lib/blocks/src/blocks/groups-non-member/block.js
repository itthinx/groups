...
const { InspectorControls, InnerBlocks } = wp.blockEditor; // Import InspectorControls, InnerBlocks from wp.blockEditor. (@since 2.11.0 requires at least WordPress 5.2)
